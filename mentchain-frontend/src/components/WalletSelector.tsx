            ...
            {!!installableWallets.length && (
              <Collapsible className="flex flex-col gap-3">
                <CollapsibleTrigger asChild>
                  <Button size="sm" variant="noShadow" className="gap-2">
    ...
    return (
      <>
        ...
        <div className="grid grid-cols-3 items-center">
          <Button size="sm" variant="default" onClick={screen.back} className="justify-self-start">
            Back
          </Button>
          ...
          <Button size="sm" variant="default" onClick={screen.next} className="gap-2 justify-self-end">
